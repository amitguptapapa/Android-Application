...
/**
 * Created by mohammadshiblee on 22/03/18.
 */

public class TableSpecialAssets {

    public static final String TABLE_NAME = "specialassetdynamic";
    ...
    static final String SQL_CREATE_DATA = ("CREATE TABLE specialasset (" +
            specialAssetColumn.data + " VARCHAR"+ ")");

    public static final String attachment = "specialasset";

    public enum specialAssetColumn {
        data,
        dynamic_data
    }

    public static final String SQL_CREATE_TABLE_SA_DYNAMIC =
    ...
    public TableSpecialAssets() {
    }


    public TableSpecialAssets(int id,String sno, String blockname, String totalslab, String height,String yrcons,String typecons,String structure,String area,String timestamp) {
