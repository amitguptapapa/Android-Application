 ...
 */
public class SkippedSurveysFragment extends Fragment {
    ...
    public void hitSkipSurveyList() {
        String url = Utils.getCompleteApiUrl(getActivity(), R.string.SkipSurveyList);

        Log.v("hitSkipSurveyList", url);
        ...
        try {
            ...
            Log.v("hitSkipSurveyList", json_data.toString());
    ...
    public void parseJson(JSONObject response) {
        Log.v("res:hitSkipSurveyList", response.toString());
        ...
        try {
            ...
            if (res_code.equals("1")) {
                ...
                for (int i = 0; i < array_case_datails.length(); i++) {
                    ...
                    hash.put("skipped_date_time", data_object.get("skipped_date_time").toString());
    ...
    public class Adapter extends RecyclerView.Adapter<HolderReferredDocuments> {
        ...
        public void onBindViewHolder(final HolderReferredDocuments holder, final int position) {
            ...
            holder.rlSkippedDate.setVisibility(View.VISIBLE);
            ...
            holder.tvSkippedDateTime.setText(alist.get(position).get("skipped_date_time"));
        }
    ...
    private static class HolderReferredDocuments extends RecyclerView.ViewHolder {
        ...
        TextView tv_caseno,tv_onrname,tv_type,tv_aadd,asign_date,sdate,tvSkippedDateTime;
        LinearLayout rl_survey,rlSkippedDate;
        View view;
        ...
        public HolderReferredDocuments(View itemView) {
            ...
            tvSkippedDateTime = itemView.findViewById(R.id.tvSkippedDateTime);
