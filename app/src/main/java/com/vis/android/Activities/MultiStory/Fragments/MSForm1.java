...
public class MSForm1 extends BaseFragment implements View.OnClickListener {
...
//    static EditText etContactNumber;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.frag_msform1, container, false);
...
//                pref.set(Constants.type_of_assets,selected_property);
    ...
    private void validation() {
        ...
        if (spinnerPurposeOfValuation.getSelectedItemPosition() == 0) {
            ...
            putIntoHm();
            ((Dashboard)mActivity).displayView(33);
            return;
        }
    }
...
/*
                ...
                try {if(object.has("radioButtonTypeOfLoan"))
