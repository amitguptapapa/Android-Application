...
public class MSForm7 extends BaseFragment implements View.OnClickListener {
...
//    RadioButton rbYes1;
    ...
    EditText etAnyOtherZoning,etAnyOtherCurrentActivity;

    ArrayList<HashMap<String, String>> sub_cat = new ArrayList<HashMap<String, String>>();

    Spinner spinnerZoningRegulations,   spinnerCurrentActivityCarried;
...
//            "SEZ", "Agricultural Land", "Farm House", "Mining Land", "For Public Amenities", "Any other"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.frag_msform7, container, false);
          ...
          /*  case R.id.rl_back:
            ...
            case R.id.next:
                if (edit_page)
                    ...
                    ((Dashboard) mActivity).displayView(41);
                break;
