...
public class MSForm4 extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.activity_generalform4, container, false);
...
//               onBackPressed();
            ...
            case R.id.next:
                if(edit_page)
                    ...
                    ((Dashboard) mActivity).displayView(36);
                break;
