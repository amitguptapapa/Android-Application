...
public class SurveyNotRequiredActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_not_required);
        ...
        tv_caseheader.setText("Survey Not Required");
        ...
        cancel_array = pref.get(Constants.array_survey_not_req);
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if (cancel_array_list.get(sp_reason.getSelectedItemPosition()).get("reason").equals("Select Reason")) {
                    Toast.makeText(SurveyNotRequiredActivity.this, "Please select cancel reason", Toast.LENGTH_SHORT).show();

                }else if(et_remark.getText().toString().isEmpty()){
                   Toast.makeText(SurveyNotRequiredActivity.this, "Please enter remarks", Toast.LENGTH_SHORT).show();

                }
                else {
                    Toast.makeText(SurveyNotRequiredActivity.this, "hit api", Toast.LENGTH_SHORT).show();
                    if (Utils.isNetworkConnectedMainThred(SurveyNotRequiredActivity.this)) {
                        loader.show();
                        loader.setCancelable(false);
                        loader.setCanceledOnTouchOutside(false);
                        hitSurveyNotRequired();

                    } else {
                        Toast.makeText(SurveyNotRequiredActivity.this, "Please Check Your Internet Connection.", Toast.LENGTH_SHORT).show();
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.homee:
                        intent = new Intent(SurveyNotRequiredActivity.this, Dashboard.class);
                        startActivity(intent);
                        return true;

                    case R.id.reassign:
                        intent = new Intent(SurveyNotRequiredActivity.this, SurveyNotRequiredActivity.class);
                        startActivity(intent);
                        return true;

                    case R.id.reschedule:
                        intent = new Intent(SurveyNotRequiredActivity.this, ScheduleActivity.class);
                        startActivity(intent);
                        return true;
    ...
    public class ReasonAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tv_reson.setText(alist.get(position).get("reason"));
            return convertView;
        }
    }
    ...
    private void hitSurveyNotRequired() {

        String url = Utils.getCompleteApiUrl(this, R.string.SurveyNotRequired);
        Log.v("hitSurveyNotRequired", url);
        ...
        try {
            ...
            jsonObject.put("reason", selected_reason);
            jsonObject.put("remark", et_remark.getText().toString());
            json_data.put("VIS", jsonObject);

            Log.v("hitSurveyNotRequired", json_data.toString());
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError error) {
                        ...
                        if (error.getErrorCode() != 0) {
                            ...
                            loader.cancel();
                            Toast.makeText(SurveyNotRequiredActivity.this, error.getErrorDetail(), Toast.LENGTH_SHORT).show();
                            Log.d("onError errorDetail", "onError errorDetail : " + error.getErrorDetail());
                        }
                    }
                });
    ...
    private void parseJson(JSONObject response) {
        ...
        Log.v("res:hitSurveyNotRequir", response.toString());
        ...
        try {
            ...
            if (msg.equals("1")) {
                Intent intent = new Intent(SurveyNotRequiredActivity.this, Dashboard.class);
                startActivity(intent);
                Toast.makeText(this, res_msg, Toast.LENGTH_SHORT).show();

            } else {
                Toast.makeText(SurveyNotRequiredActivity.this, res_msg, Toast.LENGTH_SHORT).show();
                loader.cancel();
            ...
            e.printStackTrace();
            Toast.makeText(SurveyNotRequiredActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
            loader.cancel();
        }
    }
                ...
                if (charSequence.toString().contains(" ")){
                    if (Utils.isValidEmail(charSequence.toString().trim())){
                        ...
                        if (seqSplit.length == 1){
                            Toast.makeText(SurveyNotRequiredActivity.this, "Please enter valid email", Toast.LENGTH_SHORT).show();
                        }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*if (!Utils.isValidEmail(chipInputTo.getEditText().getText().toString())){
                    ...
                    Toast.makeText(SurveyNotRequiredActivity.this, "Please enter subject", Toast.LENGTH_SHORT).show();
                }else if (etMessage.getText().toString().isEmpty()){
                    Toast.makeText(SurveyNotRequiredActivity.this, "Please enter message", Toast.LENGTH_SHORT).show();
                }else {
                    if (Utils.isNetworkConnectedMainThred(getApplicationContext())){
                        ...
                        Toast.makeText(SurveyNotRequiredActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            ...
            if (data != null) {
                ...
                Toast.makeText(SurveyNotRequiredActivity.this, "Unable to select image", Toast.LENGTH_LONG).show();
            }
