...
import com.vis.android.Database.DatabaseHelperIndDynamic;
...
public class Industrial4 extends AppCompatActivity implements OnClickListener{
    public static NotesAdapterIndustrial mAdapter;
    public static List<TableIndustrial> notesList = new ArrayList<>();
    private CoordinatorLayout coordinatorLayout;
    private RecyclerView recyclerView;
    private static TextView noNotesView;

    public static DatabaseHelperIndDynamic db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_industrial4);
        ...
        db = new DatabaseHelperIndDynamic(this);

        notesList.addAll(db.getAllIndustrialData());
        ...
        mAdapter = new NotesAdapterIndustrial(this, notesList);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.tvNext:
                Intent intent=new Intent(Industrial4.this,Industrial5.class);
    ...
    public static void createNote(String sno, String blockname, String totalslab, String height, String yrcons, String typecons, String structure, String area) {
        ...
        long id = db.insertIndustrialData(sno,blockname,totalslab,height,yrcons,typecons,structure,area);

        // get the newly inserted note from db
        TableIndustrial n = db.getIndustrialData(id);
    ...
    public static void updateNote(String sno, String blockname, String totalslab, String height, String yrcons, String typecons, String structure, String area, int position) {
        TableIndustrial n = notesList.get(position);
    ...
    public static void deleteNote(int position) {
        ...
        db.deleteIndustrialData(notesList.get(position));
        // db.deleteIndustrialData(notesList.get(position));
     ...
     * Delete - 0
     */
    public static void showActionsDialog(final int position) {
     ...
     */
    public static void showNoteDialog(final boolean shouldUpdate, final TableIndustrial note, final int position) {
