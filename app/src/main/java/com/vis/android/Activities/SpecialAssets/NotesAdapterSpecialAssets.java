...
public class NotesAdapterSpecialAssets extends RecyclerView.Adapter<NotesAdapterSpecialAssets.MyViewHolder> {

    private Context context;
    private List<TableSpecialAssets> notesList;
    ...
    public NotesAdapterSpecialAssets(Context context, List<TableSpecialAssets> notesList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        TableSpecialAssets note = notesList.get(position);
       ...
       /* holder.remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SpecialAssetsDynamicView.deleteNote(position);
            }
        });
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SpecialAssetsDynamicView.showNoteDialog(true, notesList.get(position), position);
            }
        });*/
...
//        holder.dot.setText(Html.fromHtml("&#8226;"));
    ...
    /*public void showNoteDialog(final boolean shouldUpdate, final TableSpecialAssets note, final int position) {
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (shouldUpdate && note != null) {
                    ...
                    SpecialAssetsDynamicView.updateNote(dynamicEts_no.getText().toString(),
                    ...
                    // create new note
                    SpecialAssetsDynamicView.createNote(
                            dynamicEts_no.getText().toString(),
                            dynamicEtBlock_name.getText().toString(),
                            dynamicEtSlabs.getText().toString(),
                            dynamicEtHeight.getText().toString(),
                            dynamicEtYr_Cons.getText().toString(),
    ...
    private void deleteSpecialAssetData(int position) {
        // deleting the note from db
        SpecialAssetsDynamicView.db.deleteSpecialAssetsData(notesList.get(position));
        ...
        SpecialAssetsDynamicView.mAdapter.notifyItemRemoved(position);

        SpecialAssetsDynamicView.toggleEmptyNotes();
    }
*/
    @Override
