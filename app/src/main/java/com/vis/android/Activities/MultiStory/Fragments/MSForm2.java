...
public class MSForm2 extends BaseFragment implements View.OnClickListener {
    ...
    LinearLayout dropdown,llmunsciple, llTenant, llG, llimgProp1, llimgProp2, llimgProp3, llimgElect1, llimgElect2, llimgElect3,llimgWater1, llimgWater2, llimgWater3;
    TextView next, tvPrevious, tvQuesG, tvAnyDispute,tvAnyDispute1,tvHeritage_restrictions,tv_IsMortgaged,tv_munsciple,tvNoticeOfRoadWiden,tv_NoticeOfAcquization,tv_DetailsOfGuarrentee,tv_DetailsOfExisting, tv_dispute, tv_details,tvimgProp1,tvimgProp2,tvimgProp3,tvimgElect1,tvimgElect2,tvimgElect3,tvimgWater1,tvimgWater2,tvimgWater3;
    Intent intent;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.frag_msform2  , container, false);
...
//            Toast.makeText(getActivity(), "Scheduled Case", Toast.LENGTH_SHORT).show();
        ...
        tv_munsciple = v.findViewById(R.id.tv_munsciple);
...
*/
    ...
    public void setNumber(int i) {
        if (i == 1) {
            ...
            String rbText7 = "n. Information regarding municipal taxes<font color='red'>*</font>";
            tv_munsciple.setText(Html.fromHtml(rbText7), TextView.BufferType.SPANNABLE);
             String rbText8 = "o. Whether entire piece of land is mortgaged or to be mortgaged<font color='red'>*</font>";
            tv_IsMortgaged.setText(Html.fromHtml(rbText8), TextView.BufferType.SPANNABLE);
        }
        else if(i ==2){
            ...
            tvHeritage_restrictions.setText(Html.fromHtml(rbText6), TextView.BufferType.SPANNABLE);
            String rbText7 = "p. Information regarding municipal taxes<font color='red'>*</font>";
            tv_munsciple.setText(Html.fromHtml(rbText7), TextView.BufferType.SPANNABLE);
         String rbText8 = "q. Whether entire piece of land is mortgaged or to be mortgaged<font color='red'>*</font>";
            tv_IsMortgaged.setText(Html.fromHtml(rbText8), TextView.BufferType.SPANNABLE);
        }
        else {
            ...
            tvHeritage_restrictions.setText(Html.fromHtml(rbText6), TextView.BufferType.SPANNABLE);
            String rbText7 = "o. Information regarding municipal taxes<font color='red'>*</font>";
            tv_munsciple.setText(Html.fromHtml(rbText7), TextView.BufferType.SPANNABLE);
 String rbText8 = "p. Whether entire piece of land is mortgaged or to be mortgaged<font color='red'>*</font>";
            tv_IsMortgaged.setText(Html.fromHtml(rbText8), TextView.BufferType.SPANNABLE);
...
*/
            ...
            case R.id.next:
                if(edit_page)
                    ...
                    ((Dashboard) mActivity).displayView(34);
