...
public class GeneralForm2 extends BaseFragment implements View.OnClickListener {
    ...
    TextView next, tvPrevious, tvQuesG, tvAnyDispute, tv_dispute, tv_details,tvimgProp1,tvimgProp2,tvimgProp3,tvimgElect1,tvimgElect2,tvimgElect3,tvimgWater1,tvimgWater2,tvimgWater3;
    Intent intent;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.activity_generalform2, container, false);
