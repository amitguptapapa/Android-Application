...
/**
 * Created by Rj on 19/10/19.
 */

public class VacantForm1 extends BaseFragment implements View.OnClickListener {
    //StaticString
...
//    static EditText etContactNumber;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.frag_vacantform1, container, false);
...
*/
    ...
    private void validation() {
        ...
        if (spinnerPurposeOfValuation.getSelectedItemPosition() == 0) {
            ...
            putIntoHm();
            ((Dashboard) mActivity).displayView(20);
            return;
        }
    }
    ...
    public void putIntoHm() {
        ...
        hm.put(Constants.pageVisited, "vacantform1");
...
/*
                ...
                try {
                    if (object.has("radioButtonTypeOfLoan")) {
    ...
    private void populateSinner() {
        ...
        spinnerTypeOfProperty.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               /* if (spinnerTypeOfProperty.getSelectedItemPosition() == 0) {
                    ((TextView) adapterView.getChildAt(0)).setTextColor(Color.GRAY);
                }*/
