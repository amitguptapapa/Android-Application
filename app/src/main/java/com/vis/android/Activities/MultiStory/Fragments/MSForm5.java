...
public class MSForm5 extends BaseFragment implements View.OnClickListener {
...
//    String inCaseProperty2Array[] = {"Choose an item", "Yes", "No", "No information available since full survey of the property couldn't be carried out"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.activity_generalform5, container, false);
...
*/
            ...
            case R.id.next:
                if(edit_page)
                    ...
                    ((Dashboard) mActivity).displayView(37);
                break;
