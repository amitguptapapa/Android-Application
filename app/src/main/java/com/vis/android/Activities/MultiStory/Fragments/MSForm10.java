...
public class MSForm10 extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.frag_msform10, container, false);
...
//               onBackPressed();
            ...
            case R.id.tvNext:
                if (edit_page)
                    ...
                    ((Dashboard) mActivity).displayView(42);
                break;
