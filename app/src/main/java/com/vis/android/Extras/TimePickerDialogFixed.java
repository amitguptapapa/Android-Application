 ...
 */
public class TimePickerDialogFixed extends TimePickerDialog {
     ...
     */
    public TimePickerDialogFixed(Context context, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public TimePickerDialogFixed(Context context, int themeResId, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
