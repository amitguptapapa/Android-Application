...
public class FileGalleryAdapter extends MultiSelectionAdapter<FileGalleryAdapter.ViewHolder>
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (mediaFile.getMediaType() == MediaFile.TYPE_VIDEO ||
            ...
            if (mediaFile.getPath().endsWith("xls") || mediaFile.getPath().endsWith("xlsx")) {
                holder.fileThumbnail.setImageResource(R.drawable.vw_ic_excel);
            } else if (mediaFile.getPath().endsWith("doc") || mediaFile.getPath().endsWith("docx")){
                holder.fileThumbnail.setImageResource(R.drawable.vw_ic_word);
            } else if (mediaFile.getPath().endsWith("ppt") || mediaFile.getPath().endsWith("pptx")){
                holder.fileThumbnail.setImageResource(R.drawable.vw_ic_ppt);
            } else if (mediaFile.getPath().endsWith("pdf")){
                holder.fileThumbnail.setImageResource(R.drawable.vw_ic_pdf);
            } else if (mediaFile.getPath().endsWith("txt")){
                holder.fileThumbnail.setImageResource(R.drawable.vw_ic_txt);
            } else {
                holder.fileThumbnail.setImageResource(R.drawable.vw_ic_file);
            }
